...
for h in HORIZONS:
    ...
    # Align naive predictions with X_test index:
...
# save summary
pd.DataFrame(results).pivot(index="model", columns="horizon", values="rmse").to_csv(os.path.join(RESULT_DIR,"rmse_table.csv"))
